...
export const routeTransitionAnimations = trigger('triggerName', [
    transition('One => Two, Two => Three, Three => Four, Four => Five, Five => Six', [
    ...
    transition('Six => Five, Five => Four, Four => Three, Three => Two, Two => One, Three => One, Four => One, Five => One, Six => One', [
        style({ position: 'relative' }),
        query(':enter, :leave', [
            style({
                position: 'absolute',
